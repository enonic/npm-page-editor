...
export default defineConfig({
    test: {
        ...
        server: {
            ...
            // ! Inlining routes its module through Vite's transform pipeline where
            // ! resolve.alias (react -> preact/compat) applies — without this,
            // ! Node ESM loads the real CJS react that ckeditor4-react pulls in
            // ! as a peer and the named export fails.
            deps: {
                inline: ['@enonic/ui'],
            },
        },
