...
import {type CreateFragmentViewConfig, type CreateItemViewConfig} from './CreateItemViewConfig';
...
import type {ItemType} from '@enonic/lib-contentstudio/page-editor/ItemType';
